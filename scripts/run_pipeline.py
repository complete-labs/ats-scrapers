...
CONFIGS: dict[str, dict[str, Any]] = {
    ...
    "hrmos": {
        ...
        "slug": lambda r: _slug_col(r) or (r.get("name") or "").strip() or None,
        "csv": "ats-companies/hrmos.csv",
        "output": "hrmos/jobs.csv",
    ...
    "keka": {
        ...
        "csv": "ats-companies/keka.csv",
        "output": "keka/jobs.csv",
        "dedupe_by_ats_id": True,
        "max_concurrency": 8,
        "fail_closed_on_empty": True,
        "fail_closed_on_any_error": True,
    ...
    "beisen_legacy": {
        ...
        "slug": lambda r: _slug_col(r) or (r.get("name") or "").strip() or None,
        "kwargs": lambda r: {"company_name": (r.get("name") or "").strip()},
        "csv": "ats-companies/beisen_legacy.csv",
        "output": "beisen_legacy/jobs.csv",
        "defer_descriptions_to_cache": True,
